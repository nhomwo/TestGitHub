...
Work directory was set and the two datasets were downloaded.
```{r}
setwd("C:/Study Documents/Z_The Data Science Specialization/8_Practical Machine Learning/Assignment")
...
dim(train)
```
The training data has 19622 observations and 160 feature.

The distribution of the five measured stances A,B,C,D and E 
```{r}
table(train$classe)
```
...
The cross validation accuracy is 99.7%.
...
1. The Random Forest method worked very well.
2. The Confusion Matrix achieved accuracy of 99.7%. 
